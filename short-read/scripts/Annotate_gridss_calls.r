...
vcf <- readVcf(paste(root,"RD_gridss.filter.pass.vcf", sep = ""), "hg19")         ##### NOTE: change here based on the name of your vcf file
...
writeVcf(vcf, paste(root,"GCT.gridss.sv.annotated.vcf", sep=""))# generated by example/gridss.sh  
...
write.table(simplebed, paste(root,"chr12.1527326.DEL1024.simple.bed", sep = ""), quote=FALSE, sep='\t', row.names=FALSE, col.names=FALSE)